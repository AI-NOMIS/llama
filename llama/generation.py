...
class Llama:
    ...
    def build(
        ...
        """
        Simplified model load function that initializes and loads a pre-trained model.
        """
        ...
        model_args = ModelArgs(max_seq_len=max_seq_len, max_batch_size=max_batch_size, vocab_size=tokenizer.n_words, **checkpoint['model_args'])
